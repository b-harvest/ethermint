...
`,
	...
	cmd.Flags().String(srvflags.EVMBlockExecutor, config.DefaultEVMBlockExecutor, "the block executor type (default|block-stm)")
	cmd.Flags().Uint(srvflags.EVMBlockSTMWorkers, config.DefaultEVMBlockSTMWorkers, "the number of workers for block-stm executor (default 0)")
